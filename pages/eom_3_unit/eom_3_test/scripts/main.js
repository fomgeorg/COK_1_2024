...
document.getElementById('control_button_3').style.display = 'none !important';
document.getElementById('control_button_3').style.width = '0px';
document.getElementById('control_button_3').style.height = '0px';
